 ...
 */
final class Version20240301083515 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossier_tech ADD CONSTRAINT FK_A86F1616D94300D FOREIGN KEY (nom_saison_id) REFERENCES saisons (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
